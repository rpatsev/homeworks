...
namespace RegExpTask
{
    class Program
    {
        ...
        {
            string text = @"A regular expression, regex or regexp[1] (sometimes called a rational expression)[2][3] is, in theoretical computer science and formal language theory, 
            ...
            Console.WriteLine(@"Corrected text: {0}" ,correctedText);
            ...
            //int timesRepeat = wordsRegular.Count;
